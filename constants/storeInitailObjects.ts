...
const commonFormDataFields = {
  ...
  price: { value: "0", error: "", required: true, step: 2, coardinates: "", coardinatesRequired: false },
  ...
  flightName: { value: "", error: "", required: true, step: 3, coardinates: "", coardinatesRequired: false },
  flightNumber: { value: "", error: "", required: true, step: 3, coardinates: "", coardinatesRequired: false },
